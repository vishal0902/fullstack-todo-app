...
export default function Dashboard() {
  ...
  return (
    ...
    <>
       ...
       <div className='grid grid-cols-3 justify-between  py-5 bg-gray-900  text-white'>
           <div className='flex justify-start pl-2 col-span-1'>
               <Heading text="Todoosh" />
           </div>
           
           <div className='col-span-1 text-2xl text-center text-teal-500'>hello, {firstName} {lastName}</div>
       ...
       <div className='grid grid-cols-2 mt-2 '>
           ...
           <div className='col-span-1 border-r '><AddTodo title={title} description={description} setTitle={setTitle} setDescription={setDescription} addTodo={addTodo} /></div>
           <div className='col-span-1  '><TodoList todos={todos}/></div>
